...
document.getElementById('submit').addEventListener('click', () => {
  ...
  const largeImageKey = presenceForm.largeImageKey.value
  const smallImageKey = presenceForm.smallImageKey.value

  if (!details || !state || !startTimestamp || !largeImageText || !smallImageText) {
